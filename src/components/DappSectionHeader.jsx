...
import { STAKE_TYPE, INPUTTOKEN, OUTPUTTOKEN } from '../store/constants'

const DappSectionHeader = () => {
  ...
  return (
    <header className="dapp-section__header">
      <ul className="dapp-section__tabs">
        <li className="dapp-section__tab dapp-section__tab--stake active" onClick={stakeClick}>Stake</li>
          ...
          <div className="dapp-section__settings">
            ...
            </button>
            {
              ...
              <>
                ...
                <DappSettingsWindow setIsModalVisible={setIsModalVisible} />
              </>
            }
          </div> :
          <></>
