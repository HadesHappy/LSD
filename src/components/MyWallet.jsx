  ...
  return (
    <div className="connect-wallet__my-wallet">
        <div className="connect-wallet__header connect-wallet__header--my-wallet active">
          ...
          <p className="connect-wallet__description">Connected: 0x64Fb ... FR93</p>
        </div>

        <div className="connect-wallet__actions">
          <button type="button">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.66723 1.33334L2.72953 8.45857C2.49699 8.73762 2.38072 8.87714 2.37894 8.99498C2.3774 9.09741 2.42305 9.19487 2.50273 9.25926C2.59439 9.33334 2.77601 9.33334 3.13925 9.33334H8.00056L7.33389 14.6667L13.2716 7.54143C13.5041 7.26239 13.6204 7.12286 13.6222 7.00503C13.6237 6.90259 13.5781 6.80513 13.4984 6.74074C13.4067 6.66667 13.2251 6.66667 12.8619 6.66667H8.00056L8.66723 1.33334Z" stroke="#898D94" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            Mainnet network
          </button>
          <button type="button">
          ...
          <button type="button">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14 6.00001L14 2.00001M14 2.00001H9.99999M14 2.00001L8 8M6.66667 2H5.2C4.0799 2 3.51984 2 3.09202 2.21799C2.71569 2.40973 2.40973 2.71569 2.21799 3.09202C2 3.51984 2 4.07989 2 5.2V10.8C2 11.9201 2 12.4802 2.21799 12.908C2.40973 13.2843 2.71569 13.5903 3.09202 13.782C3.51984 14 4.07989 14 5.2 14H10.8C11.9201 14 12.4802 14 12.908 13.782C13.2843 13.5903 13.5903 13.2843 13.782 12.908C14 12.4802 14 11.9201 14 10.8V9.33333" stroke="#898D94" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            Explore
          </button>
        </div>
        ...
        <footer className="connect-wallet__footer">
          <button type="button" className="connect-wallet__disconnect">Disconnect</button>
